...
void draw_cube(float ver[8][3])
{
	glColor3f(0,0,1);
	polygon(0,1,2,3); //front face
	glColor3f(0,1,0);
	polygon(4,5,6,7);	//behind face
	glColor3f(1,0,0);
	polygon(0,1,5,4);	//left face
	glColor3f(0,0,0);
	polygon(3,2,6,7);	//right face
	glColor3f(0,1,1);
	polygon(0,4,7,3);	//bottom face
	glColor3f(1,0,1);
	polygon(1,5,6,2);	//top face
}
